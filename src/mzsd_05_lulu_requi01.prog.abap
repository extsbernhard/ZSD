  ...
  CASE ok_code.
    ...
    WHEN 'SAVE'.
      ...
      IF gv_create EQ abap_true.
        ...
        MESSAGE s023(zsd_05_lulu) WITH gs_lulu_head-fallnr gv_obj gs_lulu_head-per_beginn gs_lulu_head-per_ende.
      ELSEIF gv_update EQ abap_true.
        "Meldung ausgeben
        CLEAR: gv_obj.
        CONCATENATE gs_lulu_head-stadtteil gs_lulu_head-parzelle gs_lulu_head-objekt INTO gv_obj SEPARATED BY '/'.
        MESSAGE s024(zsd_05_lulu) WITH gs_lulu_head-fallnr gv_obj gs_lulu_head-per_beginn gs_lulu_head-per_ende.
      ENDIF.
    WHEN 'DISP'.
      CLEAR: gv_create, gv_update.
      gv_display = abap_true.
    ...
    WHEN 'GET_REM_EIG'.
      IF NOT gs_lulu_head-rg_kunnr IS INITIAL.
        gs_lulu_head-eigen_kunnr = gs_lulu_head-rg_kunnr.
      ENDIF.

    WHEN 'GET_REM_VER'.
      IF NOT gs_lulu_head-rg_kunnr IS INITIAL.
        gs_lulu_head-vertr_kunnr = gs_lulu_head-rg_kunnr.
      ENDIF.
    ...
    WHEN 'OBJVERW'.
      CALL TRANSACTION 'ZSD_05_OBJEKT' AND SKIP FIRST SCREEN.
  ENDCASE.
...
MODULE check_obj_period_exists INPUT.
  ...
  MOVE-CORRESPONDING zsd_05_lulu_hd02 TO gs_lulu_head.
...
*         NOT gs_lulu_head-objekt IS INITIAL AND
        ...
        IF gv_subrc NE 0.
          IF NOT gs_lulu_head-fallnr IS INITIAL.
            MESSAGE e025(zsd_05_lulu) WITH gs_lulu_head-fallnr.
          ELSE.
            CLEAR: gv_obj.
            CONCATENATE gs_lulu_head-stadtteil gs_lulu_head-parzelle gs_lulu_head-objekt INTO gv_obj SEPARATED BY '/'.
            MESSAGE e021(zsd_05_lulu) WITH gv_obj gs_lulu_head-per_beginn gs_lulu_head-per_ende.
          ENDIF.
        ENDIF.
      ELSE.
        MESSAGE e020(zsd_05_lulu).
      ENDIF.
...
*         NOT gs_lulu_head-objekt IS INITIAL AND
        ...
        IF NOT zsd_05_lulu_hd02-per_beginn BETWEEN '20110101' AND '20121231' OR
         not ZSD_05_LULU_HD02-PER_ENDE BETWEEN '20110101' AND '20121231'.
          MESSAGE e028(zsd_05_lulu).
        ELSE.
          ...
          IF gv_subrc EQ 0.
            CLEAR: gv_obj.
            CONCATENATE gs_lulu_head-stadtteil gs_lulu_head-parzelle gs_lulu_head-objekt INTO gv_obj SEPARATED BY '/'.
            MESSAGE e022(zsd_05_lulu) WITH gv_obj gs_lulu_head-per_beginn gs_lulu_head-per_ende.
          ELSE.
