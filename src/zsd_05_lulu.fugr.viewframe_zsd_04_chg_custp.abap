*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSD_04_CHG_CUSTP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSD_04_CHG_CUSTP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSD_04_CHG_CUSTP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSD_04_CHG_CUSTP_EXTRACT
TOTAL = ZSD_04_CHG_CUSTP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSD_04_CHG_CUSTP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSD_04_CHG_CUSTP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSD_04_CHG_CUSTP_EXTRACT
TOTAL = ZSD_04_CHG_CUSTP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSD_04_CHG_CUSTP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSD_04_CHG_CUSTP'
...
TOTAL = ZSD_04_CHG_CUSTP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSD_04_CHG_CUSTP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSD_04_CHG_CUSTP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSD_04_CHG_CUSTP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSD_04_CHG_CUSTP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSD_04_CHG_CUSTP_EXTRACT
TOTAL = ZSD_04_CHG_CUSTP_TOTAL
