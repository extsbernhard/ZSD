...
SELECTION-SCREEN: BEGIN OF BLOCK bl1 WITH FRAME TITLE text-001.
 ...
 SELECT-OPTIONS: s_objkey     for zsd_05_lulu_head-obj_key "no-DISPLAY
               , s_vfgdt      for zsd_05_lulu_head-vfgdt no-DISPLAY
               , s_aszdt      for zsd_05_lulu_head-aszdt
               , s_belnr      for  zsd_05_lulu_head-belnr.
...
*             where fallnr  eq t_fk02-fallnr
             Where "  vfgdt   in s_vfgdt
                  obj_key in s_objkey
             and    aszdt in s_aszdt
             and    belnr in s_belnr.
    loop at t_hd02.
     clear t_hd02-belnr. "löschen
     clear t_hd02-aszdt. "löschen
     modify t_hd02.
    endloop.
