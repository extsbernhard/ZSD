*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZSD_MV45_CO_ABLP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZSD_MV45_CO_ABLP    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZSD_MV45_CO_ABLP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZSD_MV45_CO_ABLP_EXTRACT
TOTAL = ZSD_MV45_CO_ABLP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZSD_MV45_CO_ABLP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZSD_MV45_CO_ABLP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSD_MV45_CO_ABLP_EXTRACT
TOTAL = ZSD_MV45_CO_ABLP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZSD_MV45_CO_ABLP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZSD_MV45_CO_ABLP'
...
TOTAL = ZSD_MV45_CO_ABLP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZSD_MV45_CO_ABLP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZSD_MV45_CO_ABLP-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZSD_MV45_CO_ABLP'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZSD_MV45_CO_ABLP-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZSD_MV45_CO_ABLP_EXTRACT
TOTAL = ZSD_MV45_CO_ABLP_TOTAL
